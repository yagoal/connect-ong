        ...
        <div class="perfil">  
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Parabéns! Seu QR Code foi cadastrado com sucesso! <br>
                        Para gerenciar as doações recebidas, clique no botão abaixo.                        
                </div>

                <div class="card-footer">
                    <a class="btn btn-primary" href="Login.jsp" role="button">Gerenciar Doações</a>
                </div>
            </div>
        </div>
    </main>
