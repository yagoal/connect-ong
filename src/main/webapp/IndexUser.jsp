            ...
            <div class="caixa">
                ...
                <div class="user">
                	...
                	<b>Quantidade de animais adotados:</b> <%=session.getAttribute("listaAdo") %> <br> <br>
                        ...
                        <a href="AnimaisDisponiveis.jsp" class="btn btn-outline-primary">Adotar <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-balloon-heart" viewBox="0 0 16 16">
                        ...
                        <a href="" class="btn btn-outline-success">Doar <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-coin" viewBox="0 0 16 16">
