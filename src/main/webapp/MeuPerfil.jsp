            ...
            <img class="foto" src="<%=session.getAttribute("perfilImg") %>" alt="Foto do Usuário" style="width: 10vw;">        
                ...
                <div class="card">
                        ...
                        <ul class="dropdown-menu p-1" >
                          ...
                          <li><a href="" class="text-success d-flex justify-content-between dropdown-item d-flex align-items-center">Doar<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-coin" viewBox="0 0 16 16">
