            ...
            <img class="foto" src="resources/components/foto.svg" alt="Foto do Usuário" style="width: 10vw;">        
                ...
                <div class="card">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="d-flex justify-content-between dropdown-item d-flex align-items-center " href="#">Adotar<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-balloon-heart" viewBox="0 0 16 16">
